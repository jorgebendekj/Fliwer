...
import ClientProviderCard from './clientProviderCard.js'
...
class BusinessProviders extends Component {
    constructor(props) {
        super(props);
    ...
    renderClients() {
        ...
        usersListData=usersListData.filter(user=>user.clientObject && user.clientObject.isProvider)
...
export default connect(mapStateToProps, mapDispatchToProps)(mediaConnect(styles, BusinessProviders));
