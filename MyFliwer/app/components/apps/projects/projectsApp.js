...
class FliwerApp extends Component {
    constructor(props) {
        ...
        this.props.actions.wrapperActions.setCurrentApp("projects");
    ...
    render(){
        ...
        */
        ...
        if (this.state.loading) {
            ...
            var indents =[/*<Files forcedIndex={5}/>*/]//[this.renderPrimaryView(),this.renderSecondaryView(),this.renderFilterMenu()];
