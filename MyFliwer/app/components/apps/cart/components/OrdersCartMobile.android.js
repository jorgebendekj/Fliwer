...
//import viversplanasorder.js from assets/html/viversplanas
import { getOrderHtml } from "../../../../assets/html/viversplanas/viversplanasorder.js"; // Note the new import
                    ...
                    <TouchableOpacity 
                        onPress={async () => {
                            try {
                                ...
                                var htmlContent = getOrderHtml(currentOrder);
