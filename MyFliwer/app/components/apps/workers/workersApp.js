...
class FliwerApp extends Component {
    constructor(props) {
        ...
        this.props.actions.wrapperActions.setCurrentApp("workers");
        ...
        */
        ...
        if (this.state.loading) {
            ...
            if (this.state.resetView) {
                redirects.push(<Redirect push to={"/app/workers"} />)
                this.state.resetView = false;
            }

            if (this.state.goWorkerDetails) {
                redirects.push(<Redirect push to={`/app/workers/details/${this.state.goWorkerDetails}`} />)
    ...
    renderSecondaryView() {
        switch (this.props.currentPath) {
            case "/app/workers/details/:idWorker":
                return (
                    <WorkersDetails
    ...
    renderPrimaryView() {
        //console.log('primary')
        return <BusinessEmployers
            key={'BusinessEmployers'}
