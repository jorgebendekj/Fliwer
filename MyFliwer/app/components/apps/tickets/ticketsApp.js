...
class FliwerApp extends Component {
    constructor(props) {
        ...
        this.props.actions.wrapperActions.setCurrentApp("tickets");
    ...
    render(){
        ...
        */
        ...
        if (this.state.loading) {
            ...
            var indents =[/*<Files forcedIndex={4}/>*/]//[this.renderPrimaryView(),this.renderSecondaryView(),this.renderFilterMenu()];
