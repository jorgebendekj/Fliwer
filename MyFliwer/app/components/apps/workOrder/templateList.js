...
class TemplateList extends Component {
    ...
    render() {
        ...
        if (this.state.goADDTemplate){
            this.state.goADDTemplate=false;
            indents.push(<Redirect push to={"/app/workOrder/templates/"+this.state.goADDTemplate} />)
                    ...
                    <View style={{flexDirection: "row", flex: 1}} >
                        ...
                        >
                            <ScrollView
                                ...
                                <Text style={{padding:10,color:CurrentTheme.primaryText,fontFamily:FliwerColors.fonts.title,textAlign:"center",fontSize:18}}>{this.props.actions.translate.get('Academy_templates')}</Text>
...
export default connect(mapStateToProps, mapDispatchToProps,null, { forwardRef: true })(mediaConnect(styles, TemplateList)); 
