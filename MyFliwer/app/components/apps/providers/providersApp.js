...
import BusinessProviders from '../../business/businessProviders.js'
...
class FliwerApp extends Component {
    constructor(props) {
        ...
        this.props.actions.wrapperActions.setCurrentApp("providers");
    ...
    render(){
        ...
        */
        ...
        if (this.state.loading) {
            ...
            var indents =[<BusinessProviders/>]//[this.renderPrimaryView(),this.renderSecondaryView(),this.renderFilterMenu()];
    ...
    renderMainMenu(){
        var indents=[];
        indents.push(this.renderMenuItem(null,fliwerIcon,"Fliwer",()=>{},40));
        indents.push(this.renderMenuItem("entypo","location","Work sites"));
        indents.push(this.renderMenuItem("fontawesome","users","Clients"));
        indents.push(this.renderMenuItem("material","account-hard-hat","Workers",()=>{},35));
        indents.push(this.renderMenuItem("entypo","wallet","Wallet"));
        
        return (
            <View style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-start",alignItems:"center",backgroundColor:CurrentTheme.primaryColor,userSelect: 'none'}}>            
                <View style={{width:"100%",paddingLeft:0,paddingTop:20,display:"flex",flexDirection:"column",justifyContent:"flex-start",alignItems:"center"}}>
                    {indents}
                </View>
            </View>
        );
