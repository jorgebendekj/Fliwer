    ...
    render() {
        ...
        return (
            <View style={[this.style.container,this.props.containerStyle]}>
                <FliwerAgendaCalendarContainerDayBar current={this.state.currentDay} 
                    onPrevious={(ndays)=>{
                        var newDay=new Date(this.state.currentDay)
                        newDay.setDate(newDay.getDate()-ndays)
                        if(this.state.currentDay.getMonth()!=newDay.getMonth() || this.state.currentDay.getFullYear()!=newDay.getFullYear()){
                            this.props.actions.actionsAgendaCalendar.getMonthTasks(newDay.getMonth()+1,newDay.getFullYear());
                        }
                    ...
                    onSetDay={(day)=>{
                        if(this.state.currentDay.getMonth()!=day.getMonth() || this.state.currentDay.getFullYear()!=day.getFullYear()){
                            this.props.actions.actionsAgendaCalendar.getMonthTasks(day.getMonth()+1,day.getFullYear());
                        }
                        this.setState({currentDay:day})
                    }}
                />
                <ScrollView scrollEventThrottle={1000} style={[this.style.calendarContainer,this.props.calendarContainer]} contentContainerStyle={{width:"100%",flexGrow:1}}>
                    {this.renderDay()}
                </ScrollView>
                {this.renderAddModal()}
