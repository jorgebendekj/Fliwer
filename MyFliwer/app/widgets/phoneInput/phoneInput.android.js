...
//        console.log('El componente está disponible en el DOM');
        setTimeout(() => {
            if (!this.state.initialized) {
                var countryCode = this.phone?this.phone.getCallingCode():34;
    ...
    render() {
        ...
        let theDialCodeTopPadding = dialCodeTopPadding? dialCodeTopPadding : 13;
        ...
        return (
          <PhoneInput2
            ...
            withShadow={true}
            autoFocus={false}
            containerStyle={{width: "100%", marginTop: theMarginTop, marginBottom: theMarginBottom, height: theHeight, borderRadius: 4, zIndex: 999}}
