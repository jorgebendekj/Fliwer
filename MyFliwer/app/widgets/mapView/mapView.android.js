...
class MapView2 extends Component {
    ...
    render() {
        ...
        if (!this.state.region || this.state.defaultRegionChanged) {
            ...
            if (props.autocenter) {
                ...
                if (props.markers && props.markers.length) {
                    ...
                    initialCamera.center.latitude = centerlatitude;
                    initialCamera.center.longitude = centerlongitude;
                    initialCamera.zoom = centerzoom;
                    props.initialCamera = initialCamera;
                }
            } else {
                initialCamera.center.latitude=this.props.initialRegion.latitude?parseFloat(this.props.initialRegion.latitude):41;
                initialCamera.center.longitude=this.props.initialRegion.longitude?parseFloat(this.props.initialRegion.longitude):2;
                initialCamera.zoom=this.props.initialRegion.zoom?parseFloat(this.props.initialRegion.zoom):16;
