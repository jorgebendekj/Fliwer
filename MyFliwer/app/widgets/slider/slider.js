...
//        trackStyle: ViewPropTypes ? ViewPropTypes.style : PropTypes.object,
        trackStyle: {},
...
//        thumbStyle: ViewPropTypes ? ViewPropTypes.style : PropTypes.object,
        thumbStyle: {},

        /**
         * Sets an image for the thumb.
         */
        thumbImage: Image.ImageSourcePropType,
    ...
    _renderThumbContent = () => {
        const {thumbContent} = this.props;
        if (!thumbContent || typeof thumbContent !== 'function')
            return;
        else
            return thumbContent();
    };
