    ...
    render() {
        ...
        return (
                <TouchableOpacity style={{height: "100%", width: "100%", backgroundColor: bgc, display: "flex", alignItems: "center", justifyContent: "center"}} onPress={() => {
                    ...
                    {!this.state.loading?<Icon name="play" style={{color: "white", fontSize: 122, zIndex: 1, textShadowRadius: 20, textShadowColor: "black"}} ></Icon>:null}
                    {this.renderModal()}
                </TouchableOpacity>
                )
    }
                            ...
                            {isUrl?
                                <View style={{width: "100%", height: "100%"}}>
                                    <WebView
                                        ...
                                        source={{ uri: source }} 
                                    />
                                    <TouchableOpacity style={[this.style.exitButtonTouch, {}]} activeOpacity={1} onPress={() => {
                                            this.closeVideo();
                                        }}>
                                        <IconMaterialIcons name="exit-to-app" size={24} style={{color: "white"}}/>
                                    </TouchableOpacity>   
                                </View>
                            :
                                <Video
