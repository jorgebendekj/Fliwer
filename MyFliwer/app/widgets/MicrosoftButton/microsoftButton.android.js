...
class MyAppleButton extends Component {
    ...
    _signIn = async () => {
       ...
       const azureAuth = new AzureAuth({
        ...
        try {
           let tokens = await azureAuth.webAuth.authorize({scope: 'openid email profile User.Read UserAuthenticationMethod.Read' })
           if (this.props.onLogin)this.props.onLogin(tokens.accessToken);
         } catch (error) {
